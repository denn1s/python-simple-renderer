...
# ejemplo 1.0 linea con incremento constante

def line0_5(x1, y1, x2, y2):
    i = 0
    while i <= 1:
        x = x0 + (x1 - x0) * i
        y = y0 + (y1 - y0) * i
...
# line1(13, 20, 80, 40); 
# line1(20, 13, 40, 80); 
# line1(80, 40, 13, 20);  # simetry test, es la primera linea pero revertida

# que podemos hacer? ideas? (darle la vuelta a la linea)

# si x1 > x2, podemos darle la vuelta a la linea
